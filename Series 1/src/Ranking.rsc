...
str rankTestability(str complexity, str uSize){
	int gradeComp = rankToGrade(complexity);
	int gradeuSize = rankToGrade(uSize);
	
	int grade = floor((gradeComp + gradeuSize) / 2.0);
	return gradeToRank(grade);
}

str rankTestabilityBonus(str complexity, str uSize, str uTest){
	int gradeComp = rankToGrade(complexity);
	int gradeuSize = rankToGrade(uSize);
...
str rankAnalysabilityBonus(str vol, str dup, str usize, str utest){
	int gradeVol = rankToGrade(vol);
	int gradeDup = rankToGrade(dup);
	int gradeUSize = rankToGrade(usize);
	int gradeUTest = rankToGrade(utest);
	
	int grade = floor((gradeVol + gradeDup + gradeUSize + gradeUTest) / 4.0);
	return gradeToRank(grade);
}
...
str rankChangeabilityBonus(str complexity, str dup){
	int gradeComp = rankToGrade(complexity);
	int gradeDup = rankToGrade(dup);
...
str rankMaintainability(str analysability, str changeability, str testability){
	...
	int grade = floor((gradeAnalysability + gradeChangeability + gradeTestability ) / 3.0);
	return gradeToRank(grade);
}

str rankMaintainabilityBonus(str analysability, str changeability, str stability, str testability){
	int gradeAnalysability = rankToGrade(analysability);
	int gradeChangeability = rankToGrade(changeability);
	int gradeTestability = rankToGrade(testability);
...
str rankMaintainabilityBonus(str analysability, str changeability, str stability, str testability, str reusability){
	int gradeAnalysability = rankToGrade(analysability);
	int gradeChangeability = rankToGrade(changeability);
	int gradeTestability = rankToGrade(testability);
	int gradeStability = rankToGrade(stability);
	int gradeReusability = rankToGrade(reusability);
	
	int grade = floor((gradeAnalysability + gradeChangeability + gradeTestability + gradeStability + gradeReusability) / 5.0);
	return gradeToRank(grade);
}

str rankReusability(str interfacing, str usize){
	int gradeInterfacing = rankToGrade(interfacing);
	int gradeUSize = rankToGrade(usize);
	
	int grade = floor((gradeInterfacing + gradeUSize) / 2.0);
	return gradeToRank(grade);
}
